...
hi Normal     guisp=NONE guifg=#d0c0a0 guibg=#052329 ctermfg=181 ctermbg=234  gui=NONE cterm=NONE
hi Comment    guisp=NONE guifg=#ffffff guibg=NONE    ctermfg=231 ctermbg=NONE gui=NONE cterm=NONE
hi Constant   guisp=NONE guifg=#ffffff guibg=NONE    ctermfg=231 ctermbg=NONE gui=NONE cterm=NONE
hi Identifier guisp=NONE guifg=#d0c0a0 guibg=NONE    ctermfg=181 ctermbg=NONE gui=NONE cterm=NONE
hi Statement  guisp=NONE guifg=#d0c0a0 guibg=NONE    ctermfg=181 ctermbg=NONE gui=NONE cterm=NONE
hi PreProc    guisp=NONE guifg=#ffffff guibg=NONE    ctermfg=231 ctermbg=NONE gui=NONE cterm=NONE
hi Type       guisp=NONE guifg=#d0c0a0 guibg=NONE    ctermfg=181 ctermbg=NONE gui=NONE cterm=NONE
...
hi Error      guisp=NONE guifg=#ffffff guibg=NONE    ctermfg=231 ctermbg=NONE gui=NONE cterm=NONE
hi Todo       guisp=NONE guifg=#ffffff guibg=NONE    ctermfg=231 ctermbg=NONE gui=NONE cterm=NONE

" minor

hi String         guisp=NONE guifg=#ffffff guibg=NONE ctermfg=231 ctermbg=NONE gui=NONE cterm=NONE
hi Character      guisp=NONE guifg=#ffffff guibg=NONE ctermfg=231 ctermbg=NONE gui=NONE cterm=NONE
hi Number         guisp=NONE guifg=#ffffff guibg=NONE ctermfg=231 ctermbg=NONE gui=NONE cterm=NONE
hi Boolean        guisp=NONE guifg=#ffffff guibg=NONE ctermfg=231 ctermbg=NONE gui=NONE cterm=NONE
hi Float          guisp=NONE guifg=#ffffff guibg=NONE ctermfg=231 ctermbg=NONE gui=NONE cterm=NONE
hi Function       guisp=NONE guifg=#ffffff guibg=NONE ctermfg=231 ctermbg=NONE gui=NONE cterm=NONE
hi Conditional    guisp=NONE guifg=#ffffff guibg=NONE ctermfg=231 ctermbg=NONE gui=NONE cterm=NONE
hi Repeat         guisp=NONE guifg=#ffffff guibg=NONE ctermfg=231 ctermbg=NONE gui=NONE cterm=NONE
...
hi Include        guisp=NONE guifg=#ffffff guibg=NONE ctermfg=231 ctermbg=NONE gui=NONE cterm=NONE
...
hi Structure      guisp=NONE guifg=#ffffff guibg=NONE ctermfg=231 ctermbg=NONE gui=NONE cterm=NONE
hi Typedef        guisp=NONE guifg=#ffffff guibg=NONE ctermfg=231 ctermbg=NONE gui=NONE cterm=NONE
